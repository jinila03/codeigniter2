...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link" href='<?php echo base_url();?>index.php/Welcome/admin'>Admin Home</a>
          </li>
          <!-- Dropdown -->
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="<?php echo base_url();?>index.php/Welcome/taskuserview">Task</a></li>
  ...
  <section class="hero">
    <div class="container text-center">
      ...
      <p class="lead">Your catchy slogan or introduction can go here.</p>
