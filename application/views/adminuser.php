...
<body>
    ...
    <form action="<?php echo base_url();?>index.php/Welcome/adminuser" method="post">
        <tr><td>
                ...
                <?php foreach($data as  $d)
                                { ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url();?>index.php/Welcome/task/<?php echo $tid;?>"class="btn btn-danger">Assume work</td>
