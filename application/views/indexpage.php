    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href='<?php echo base_url();?>index.php/Welcome/login1'>Login</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="nav-link" href='<?php echo base_url();?>index.php/Welcome/admin'>Admin Home</a></li>
           <li> <a class="nav-link" href='<?php echo base_url();?>index.php/Welcome/uhome'>User</a></li>
